...
window.onload=relayout;
	...
	<img id="imgInit" src="" style='display:block;position:absolute;left:0px; width:100%;height:100% margin-top:0px; margin-left:0px; left:0px;top:0px;z-index:-1;'/>
	...
	<div id="inputlayer"  onselectstart="return false" align="bottom" style="position: absolute;float: left;left:7.8%;top:73.3%; width:92.2%" >
	  ...
	  <textarea id="inputview" class="comments"  readonly  style="poistion:absolute; font: normal Helvetica, Arial, sans-serif; width:58.8%; font-size:13px;"><?php  echo $row['content']; ?></textarea>
	</div>
